  ...
  navbar:
    tools:
      - icon: github
        menu:
          - text: Source Code
            href: https://github.com/SerranoLab/Golden_etal_2024
format: 
  html:
    code-link: true
    code-fold: true
