...
+---------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Treatment 2**     | Trichostatin A (TSA)                                                                                                                    |
|                     |                                                                                                                                                          |
|                     | HDAC inhibitor, showed to increase H3K27ac (PMID: [23093607](https://pubmed.ncbi.nlm.nih.gov/23093607)). Expected outcome: increase in acetylation marks |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Treatment 3**     | Vorinostat (SAHA) (0.5, 0.75 and 1 µM)                                                                                                                      |
|                     |                                                                                                                                                          |
|                     | HDAC inhibitor, showed to increase H3K9ac (PMID: [28978082](https://pubmed.ncbi.nlm.nih.gov/28978082)). Expected outcome: increased acetylation marks.   |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Replicates**      | 3 biological replicates per experimental group                                                                                                           |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
...
::: callout-warning
OMIQ workflow: Blank cpontrols were acquired for gating but are not included in this downstream analysis. Sampling was performed as max equal because TSA treatment substantially reduced the number of cells.
:::

**Data pre-processing**
* Files were concatenated by treatment when downloaded
* files are coded so that 1.1, 1.2 and 1.3 (2.x, 3.x, 4.x) are biological replicates of each treatment. To prevent confusion, I added *treatment* column with this information.
* Kept original OMIQ files un-altered but generated a concatenated file per feature located in the input folder that contains all the necessary information for proper analysis. 
* Files will be transform to long format individually and then merged
...
ggsave("output/PNG/density_plot_8.png", width = 10, height = 15, units = "cm", dpi = 300)
ggsave("output/SVG/density_plot_8.svg", plot = dr6, width = 10, height = 15, units = "cm")
